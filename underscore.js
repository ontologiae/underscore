...
(function() {
  ...
  _.indexOf = function(array, item, isSorted) {
    ...
    if (isSorted) {
      ...
      return eq(array[i],item) ? i : -1;//TODO
    }
    if (nativeIndexOf && array.indexOf === nativeIndexOf) return array.indexOf(item);
    for (i = 0, l = array.length; i < l; i++) if (eq(array[i] , item)) return i; //TODO
    return -1;
  };
  ...
  _.lastIndexOf = function(array, item) {
    ...
    var i = array.length;
    while (i--) if (eq(array[i] , item)) return i;//TODO
    return -1;
  };
  ...
  _.bind = function bind(func, context) {
    ...
    return bound = function() {
      ...
      if (Object(result) === result) return result; //TODO
      return self;
    };
  };
